    ...
    t = {
        ...
        constructor: i, _cleanup: function () {
            ...
            var v, h, w, b = this, _ = b.slug(r), C = "", y = "",
                ...
                P = _, I = "type-default", E = u || b._renderFileFooter(i, _, d, "auto", s), k = b.preferIconicPreview,
                S = b.preferIconicZoomPreview, F = k ? "other" : i;
            return h = 400 > x ? b.previewSettingsSmall[F] || b.defaults.previewSettingsSmall[F] : b.previewSettings[F] || b.defaults.previewSettings[F], h && e.each(h, function (e, t) {
                y += e + ":" + t + ";"
            }), w = function (a, s, d, u) {
            ...
            i._getThumbs().each(function () {
                ...
                "-1" !== n && -1 !== n && (i.fileManager.getFile(r.attr("data-fileid")) ? r.attr({
                    ...
                    id: "zoom-" + r.attr("id"), "data-fileindex": r.attr("data-fileindex")
                }))
            })
